...
do
    ...
    ThemeManager.BuiltInThemes = {
        ["Default"] = {
            1,
            { FontColor = "ffffff", MainColor = "808080", AccentColor = "87CEEB", BackgroundColor = "808080", OutlineColor = "ffffff", FontFace = "SourceSans" },
        },
        ["BBot"] = {
            2,
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        groupbox:AddDropdown("ThemeManager_CustomThemeList", { Text = "Custom Theme", Values = self:ReloadCustomThemes(), AllowNull = true, Default = 1 })
        ...
        groupbox:AddButton("Delete Theme", function()
            ...
            if not success then
                self.Library:Notify("Unable to delete theme: " .. err)
                return
            end
    ...
    function ThemeManager:CreateGroupBox(tab)
        assert(self.Library, "Must set ThemeManager.Library first!")
        return tab:AddLeftGroupbox("Theme", "paintbrush")
    end
